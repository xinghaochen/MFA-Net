...
PREFIX=feature_hand_global_skeleton_new_backbone
...
do
    ...
    TF_CPP_MIN_LOG_LEVEL=1 python -u src/main.py -d $DATA_DIR -i $i -l 0.001 -b 32 -e 100 -s $PREFIX -m 0 -data 5 -ml 64 -f 0 -nsbo
done
