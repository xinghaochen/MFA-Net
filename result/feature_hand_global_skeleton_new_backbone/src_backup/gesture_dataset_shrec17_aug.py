...
class Dataset(object):
    ...
    def load_data_with_feature(self, do_pca, pca_dim, M, max_dist_factor, offset1, offset2, is_normalize, is_preprocess=True):
        x_train_skeleton = []
        x_train_global = []
        x_train_hand = []
        y_train = []
    ...
    def load_data_with_vae_feature(self, do_pca, pca_dim, M, max_dist_factor, offset1, offset2, is_normalize, is_preprocess=True):
        x_train_skeleton = []
        x_train_global = []
        x_train_hand = []
        y_train = []
