...
PREFIX=feature_hand_global_skeleton_vae_full
...
do
    ...
    TF_CPP_MIN_LOG_LEVEL=1 python src/main.py -d $DATA_DIR -i $i -l 0.001 -b 32 -e 100 -s $PREFIX -m 0 -data 7 -ml 64 -f 1 -nsbo
done
