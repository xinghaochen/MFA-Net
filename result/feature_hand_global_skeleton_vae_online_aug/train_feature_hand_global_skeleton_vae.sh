...
PREFIX=feature_hand_global_skeleton_vae_online_aug
...
do
    ...
    TF_CPP_MIN_LOG_LEVEL=1 python src/main.py -d $DATA_DIR -i $i -l 0.005 -b 64 -e 200 -s $PREFIX -m 0 -data 7 -ml 100 -f 0 -nsbo
done
