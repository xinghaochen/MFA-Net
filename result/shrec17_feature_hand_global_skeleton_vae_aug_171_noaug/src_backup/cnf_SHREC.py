...
def computer_confusion_matrix():
  ...
  # Generate Dataset
  data_root = '/home/workspace/Datasets/HandGestureDataset_SHREC2017'
  out_prefix = 'shrec17_feature_hand_global_skeleton_vae_aug_171'
  if num_classes == 28:
      out_prefix += '_full'

  data = gesture_dataset_shrec17.Dataset(data_root, is_full, is_aug=False)
  (x_train, y_train), (x_test, y_test) = data.load_data(is_preprocess=False, is_sub_center=False)
