...
PREFIX=feature_hand_global_skeleton_new_bi
...
do
    ...
    touch $LOGFILE
    echo $LOGFILE
    TF_CPP_MIN_LOG_LEVEL=1 python src/main.py -d $DATA_DIR -i $i -l 0.001 -b 32 -e 100 -s $PREFIX -m 0 -data 5 -nsbo -bi -ml 100 2>&1 | tee $LOGFILE
done
