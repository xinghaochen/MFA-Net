...
PREFIX=feature_hand_global_skeleton_vae_ml100_ep20
...
do
    ...
    TF_CPP_MIN_LOG_LEVEL=1 python src/main.py -d $DATA_DIR -i $i -l 0.001 -b 32 -e 20 -s $PREFIX -m 0 -data 7 -ml 100 -f 0 -nsbo
done
