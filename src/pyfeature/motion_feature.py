...
def extract_feature_for_frame_vae(joint, natural_hand_joints, vae, dataset='SHREC17'):
    """
...
def extract_feature_global_amp(seq, M, max_dist_factor, dataset='SHREC17'):
    """
...
def extract_all_feature_for_frame_vae(x, test_id, M, max_dist_factor, offset1, offset2, vae, dataset='SHREC2017'):
    """
    ...
    for fid in range(N):  # frame id
        ...
        frame_feature = extract_feature_for_frame_vae(joint, natural_hand_joints, vae, dataset)
