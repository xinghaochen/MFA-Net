...
PREFIX=shrec17_feature_hand_global_skeleton_vae_aug_171_full
...
TF_CPP_MIN_LOG_LEVEL=1 python -u src/main.py -d $DATA_DIR -dataset SHREC17 -l 0.001 -b 32 -e 100 -s $PREFIX -m 0 -data 7 -ml 171 -f 1 -nsbo
